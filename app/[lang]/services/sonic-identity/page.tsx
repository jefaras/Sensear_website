        ...
        <div className="bg-[#faebe3]">
            ...
            <section className="py-20 bg-white"><div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="hidden lg:block"><Image src="/images/services/sonic-identity/sonic-identity-workshop.jpg" alt="Sonic DNA workshop and brand audio strategy" width={800} height={600} sizes="(max-width: 1024px) 100vw, (max-width: 1536px) 50vw, 800px" loading="eager" className="w-full h-auto rounded-2xl shadow-lg" /></div>
            ...
            <section className="py-20" style={{ backgroundImage: "linear-gradient(to top, #ffffff 0%, rgba(255,255,255,0) 15%), url('/images/backgrounds/background-texture-warm-silver.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}><div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="hidden lg:block"><Image src="/images/services/sonic-identity/sonic-identity-development.jpg" alt="Brand sonic identity development" width={800} height={600} sizes="(max-width: 1024px) 100vw, (max-width: 1536px) 50vw, 800px" loading="eager" className="w-full h-auto rounded-2xl shadow-lg" /></div>
                </div>
            </div></section>
            <section className="py-20 bg-white"><div className="max-w-7xl mx-auto px-6">
                <h2 className="text-[2.7rem] md:text-[3.45rem] font-bold mb-12 text-black text-center leading-heading">{t.identity.title}</h2>
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="hidden lg:block"><Image src="/images/services/sonic-identity/sonic-identity-implementation.jpg" alt="Sonic identity implementation process" width={800} height={600} sizes="(max-width: 1024px) 100vw, (max-width: 1536px) 50vw, 800px" className="w-full h-auto rounded-2xl shadow-lg" /></div>
                    <div className="space-y-8">
