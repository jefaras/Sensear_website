        ...
        <div className="bg-[#faebe3]">
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <ScrollReveal className="hidden lg:block relative aspect-[3/4]">
                            <Image src={t.what_we_do.image} alt="Hotel music implementation" fill sizes="(max-width: 1024px) 100vw, (max-width: 1536px) 50vw, 600px" loading="eager" className="object-cover rounded-2xl shadow-lg" />
                        </ScrollReveal>
                        <StaggerChildren className="space-y-8" staggerDelay={0.1}>
                            {t.what_we_do.items.map((item, index) => (
                                <div key={index}><h3 className="text-2xl font-bold text-black mb-3">{item.title}</h3><p className="text-lg text-black/70" dangerouslySetInnerHTML={{ __html: item.description }} /></div>
                            ))}
                        </StaggerChildren>
                    </div>
                </div>
            ...
            <section className="py-20" style={{ backgroundImage: "url('/images/backgrounds/background-texture-warm-silver.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
                <div className="max-w-7xl mx-auto px-6">
                    <ScrollReveal>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <ScrollReveal className="hidden lg:block relative aspect-[3/4]">
                            <Image src={t.ideal_for.image} alt="Luxury hotel terrace with elegant atmosphere" fill sizes="(max-width: 1024px) 100vw, (max-width: 1536px) 50vw, 600px" loading="eager" className="object-cover rounded-2xl shadow-lg" />
                        </ScrollReveal>
                    </div>
                </div>
            </section>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <ScrollReveal className="hidden lg:block relative aspect-[3/4]">
                            <Image src={t.how_we_help.image} alt="Silver ear sculpture representing listening and sonic branding" fill sizes="(max-width: 1024px) 100vw, (max-width: 1536px) 50vw, 600px" className="object-cover rounded-2xl shadow-lg" />
                        </ScrollReveal>
                        <StaggerChildren className="space-y-8" staggerDelay={0.1}>
