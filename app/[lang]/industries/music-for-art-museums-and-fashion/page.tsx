...
export async function generateMetadata({ params }: { params: Promise<{ lang: Locale }> }): Promise<Metadata> {
    ...
    const t = dict.art_museums_fashion;

    return {
        alternates: localeAlternates(lang, "/industries/music-for-art-museums-and-fashion"),
        title: t.meta?.title || "Music for Art, Museums & Fashion | SensEar",
        description: lang === "el"
            ? "Εξειδικευμένη μουσική επιμέλεια για μουσεία, γκαλερί και εκδηλώσεις μόδας. Δημιουργούμε τη μοναδική ηχητική ταυτότητα του χώρου σας."
            : "Bespoke music curation for museums, galleries, and fashion events. We craft your venue's unique sonic identity.",
        openGraph: {
            title: t.meta?.title || "Music for Art, Museums & Fashion | SensEar",
            description: lang === "el"
        ...
        <div className="bg-[#faebe3]">
            <section className="relative pt-20 sm:pt-24 md:pt-28 lg:pt-32 xl:pt-32 pb-8 lg:pb-24 min-h-[90vh] lg:min-h-screen flex flex-col justify-center overflow-hidden" style={{ backgroundImage: "url('/images/backgrounds/background-texture-warm-silver.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
                <div className="w-full px-6 md:px-12 lg:px-16"><div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="flex flex-col justify-center text-left">
                        <ScrollReveal><h1 className="font-extrabold text-black mb-6 leading-[1.1]"><span className="block mb-3 text-[2.2rem] sm:text-[3.2rem] md:text-[4rem] lg:text-[4.8rem]">{t.hero.title}</span><span className="block text-[1.6rem] sm:text-[2.4rem] md:text-[3rem] lg:text-[3.6rem] text-black/70 italic">{t.hero.subtitle}</span></h1></ScrollReveal>
            ...
            <section className="py-20 bg-white"><div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <ScrollReveal className="hidden lg:block relative aspect-[3/4]"><Image src={t.what_we_do.image} alt="Fashion runway show" fill sizes="(max-width: 1024px) 100vw, (max-width: 1536px) 50vw, 600px" loading="eager" className="object-cover rounded-2xl shadow-lg" /></ScrollReveal>
                </div>
            </div></section>
            <section className="py-20" style={{ backgroundImage: "url('/images/backgrounds/background-texture-warm-silver.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}><div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <ScrollReveal className="hidden lg:block relative aspect-[3/4]"><Image src={t.ideal_for.image} alt="Fashion portrait" fill sizes="(max-width: 1024px) 100vw, (max-width: 1536px) 50vw, 600px" loading="eager" className="object-cover rounded-2xl shadow-lg" /></ScrollReveal>
                </div>
            </div></section>
            <section className="py-20 bg-black"><div className="max-w-7xl mx-auto px-6">
                <ScrollReveal><h2 className="text-[2.7rem] md:text-[3.45rem] font-bold mb-12 text-white text-center leading-heading">{t.how_we_help.title}</h2></ScrollReveal>
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <ScrollReveal className="hidden lg:block relative aspect-[3/4]"><Image src={t.how_we_help.image} alt="Fashion editorial" fill sizes="(max-width: 1024px) 100vw, (max-width: 1536px) 50vw, 600px" className="object-cover rounded-2xl shadow-lg" /></ScrollReveal>
                ...
                <div className="max-w-2xl mx-auto mt-16 text-center">
                    <ScrollReveal><h3 className="text-2xl md:text-3xl font-bold text-white mb-4">{t.how_we_help.cta_title}</h3></ScrollReveal>
                    <ScrollReveal delay={0.1}><p className="text-lg md:text-xl text-white/80 mb-6">{t.how_we_help.cta_description}</p></ScrollReveal>
                    <ScrollReveal delay={0.18}><div className="flex justify-center"><AnimatedButton href={`${t.how_we_help.cta_link}`} lang={lang} className="px-14" variant="dark">{t.how_we_help.cta_button}</AnimatedButton></div></ScrollReveal>
                </div>
            </div></section>
            <FinalCTA
                heading={lang === "el" ? "Αναβαθμίστε την πολιτιστική ατμόσφαιρα" : "Upgrade your cultural atmosphere"}
