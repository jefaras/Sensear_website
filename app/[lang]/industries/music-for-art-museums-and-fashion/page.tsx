        ...
        <div className="bg-[#faebe3]">
            ...
            <section className="py-20 bg-black"><div className="max-w-7xl mx-auto px-6">
                ...
                <div className="max-w-2xl mx-auto mt-16 text-center">
                    <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">{t.how_we_help.cta_title}</h3>
                    <p className="text-lg md:text-xl text-white/80 mb-6">{t.how_we_help.cta_description}</p>
                    <div className="flex justify-center">
                        <AnimatedButton href={`${t.how_we_help.cta_link}`} lang={lang} className="px-14" variant="dark">
