    ...
    return (
        <div className="bg-[#faebe3]">
            ...
            <section className="py-20 bg-white"><div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <ScrollReveal className="hidden lg:block relative aspect-[3/4]"><Image src={t.what_we_do.image} alt="Cocktail glass with ice representing bar atmosphere" fill sizes="(max-width: 1024px) 100vw, (max-width: 1536px) 50vw, 600px" loading="eager" className="object-cover rounded-2xl shadow-lg" /></ScrollReveal>
            ...
            <section className="py-20" style={{ backgroundImage: "url('/images/backgrounds/background-texture-warm-silver.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}><div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <ScrollReveal className="hidden lg:block relative aspect-[3/4]"><Image src={t.ideal_for.image} alt="Elegant dining scene with guests enjoying atmosphere" fill sizes="(max-width: 1024px) 100vw, (max-width: 1536px) 50vw, 600px" loading="eager" className="object-cover rounded-2xl shadow-lg" /></ScrollReveal>
                </div>
            </div></section>
            ...
            <section className="py-20 bg-white"><div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <ScrollReveal className="hidden lg:block relative aspect-[3/4]"><Image src={t.how_we_help.image} alt="Vibrant bar scene with guests dancing and enjoying music" fill sizes="(max-width: 1024px) 100vw, (max-width: 1536px) 50vw, 600px" className="object-cover rounded-2xl shadow-lg" /></ScrollReveal>
                    <StaggerChildren className="space-y-8" staggerDelay={0.1}>
                ...
                <div className="max-w-2xl mx-auto mt-16 text-center">
                    <ScrollReveal><h3 className="text-2xl md:text-3xl font-bold text-black mb-4">{t.how_we_help.cta_title}</h3></ScrollReveal>
                    <ScrollReveal delay={0.1}><p className="text-lg md:text-xl text-black/70 mb-6">{t.how_we_help.cta_description}</p></ScrollReveal>
                    <ScrollReveal delay={0.18}><div className="flex justify-center"><AnimatedButton href={`${t.how_we_help.cta_link}`} lang={lang} className="px-14">{t.how_we_help.cta_button}</AnimatedButton></div></ScrollReveal>
                </div>
            </div></section>
